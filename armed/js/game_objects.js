...
Player.prototype.update(delta_time) {

}

Player.prototype.draw(context) {

}

Player.prototype.addProjectile() {
  this.projectiles.push();
}

Player.prototype.removeProjectile(index) {
...
Effect Classes
****************************************/
function Smoke(x,y,lifespan,image) {
  this.x = x;
  this.y = y;
  this.image = image;
